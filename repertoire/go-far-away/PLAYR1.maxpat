...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 514.0, 401.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 498.0, 357.0, 91.0, 22.0 ],
					"style" : "",
					"text" : "route P1wetdry"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 374.5, 357.0, 111.0, 22.0 ],
					"style" : "",
					"text" : "route P1decaytime"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 237.0, 376.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 226.0, 352.0, 111.0, 22.0 ],
					"style" : "",
					"text" : "route P1reverbsize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 342.0, 294.0, 99.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 124.0, 407.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 973.0, 248.5, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 934.166687, 148.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "sel 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 934.166687, 120.0, 50.5, 22.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 210.5, 330.5, 214.0, 20.0 ],
					"style" : "",
					"text" : "Reverber8r (Controlled by PLAYR 2)"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 411.5, 54.0, 150.0, 20.0 ],
					"style" : "",
					"text" : "Long Tone - Granular"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 170.000015, 284.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 578.5, 382.5, 179.0, 40.0 ],
					"style" : "",
					"text" : "RZ ~ volume"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 91.0, 290.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 578.5, 338.5, 242.0, 40.0 ],
					"style" : "",
					"text" : "LZ ~ \tspeed/pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 361.5, 2.0, 167.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 403.0, 11.0, 167.0, 40.0 ],
					"style" : "",
					"text" : "PLAYR 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 345.666656, 447.0, 189.0, 111.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 223.0, 347.0, 189.0, 111.0 ],
					"prototypename" : "pixl",
					"varname" : "reverber8r",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 794.5, 302.333344, 96.0, 22.0 ],
					"style" : "",
					"text" : "scale 1. 0. -70 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 578.5, 171.5, 208.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "gametrakr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 42.0, 166.0, 378.0, 159.0 ],
					"prototypename" : "pixl",
					"varname" : "aplayr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 913.166687, 302.333344, 71.0, 292.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 422.0, 166.0, 71.0, 292.0 ],
					"prototypename" : "pixl",
					"varname" : "hemi-m",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-20" : [ "pictctrl[9]", "pictctrl[1]", 0 ],
			...
			"obj-2::obj-4" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
