...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 646.0, 422.0, 92.0, 22.0 ],
					"style" : "",
					"text" : "scale 0. 1. 0. 6."
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 558.5, 476.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 333.25, 376.000031, 29.5, 22.0 ],
					"style" : "",
					"text" : "0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 281.0, 328.700012, 114.0, 22.0 ],
					"style" : "",
					"text" : "route P3tremrdepth"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 150.0, 359.5, 150.0, 147.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 131.600006, 354.399994, 150.0, 147.0 ],
					"prototypename" : "pixl",
					"varname" : "tremr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 939.0, 106.0, 50.5, 22.0 ],
					"style" : "",
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 103.5, 141.399994, 407.0, 40.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 295.5, 348.899994, 182.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 389.5, 465.0, 144.0, 111.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 306.0, 372.399994, 144.0, 111.0 ],
					"prototypename" : "pixl",
					"varname" : "drivr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 637.5, 49.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 639.0, 399.399994, 196.0, 40.0 ],
					"style" : "",
					"text" : "RZ ~ volume"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 630.0, 357.399994, 233.0, 40.0 ],
					"style" : "",
					"text" : "LZ ~ speed/pitch"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 939.0, 157.399994, 64.0, 35.0 ],
					"style" : "",
					"text" : "counter 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 642.5, 190.399994, 208.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "gametrakr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 308.0, 122.0, 378.0, 159.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 115.5, 186.399994, 378.0, 159.0 ],
					"prototypename" : "pixl",
					"varname" : "aplayr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 495.5, 186.399994, 71.0, 292.0 ],
					"prototypename" : "pixl",
					"varname" : "hemi-m",
					"viewvisibility" : 1
				}
