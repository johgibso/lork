...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 553.5, 392.5, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 22.666626, 286.0, 71.0, 20.0 ],
					"style" : "",
					"text" : "HIGH GAIN"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 538.5, 377.5, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 29.666626, 256.0, 73.0, 20.0 ],
					"style" : "",
					"text" : "MED GAIN"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 22.666626, 224.0, 73.0, 20.0 ],
					"style" : "",
					"text" : "LOW GAIN"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 708.25, 366.500061, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 97.666626, 285.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 655.25, 383.500031, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 97.666626, 255.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 604.916626, 400.500031, 29.5, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 97.666626, 223.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"presentation_rect" : [ 592.0, 298.0, 132.0, 73.0 ],
					"style" : "",
					"text" : "LZ ~  \nfeedback"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 724.0, 298.0, 122.0, 73.0 ],
					"style" : "",
					"text" : "RZ ~ \nwet/Dry"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 442.0, 298.0, 148.0, 73.0 ],
					"style" : "",
					"text" : "LY ~ \ndelay time"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 580.0, 472.0, 32.0, 22.0 ],
					"style" : "",
					"text" : "*~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.166687, 187.0, 31.0, 22.0 ],
					"style" : "",
					"text" : "127"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 422.0, 100.000031, 180.0, 172.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 139.0, 192.0, 180.0, 172.0 ],
					"prototypename" : "pixl",
					"varname" : "1shotr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 406.0, 59.0, 150.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 399.0, 17.0, 256.0, 40.0 ],
					"style" : "",
					"text" : "PLAYR 6"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 139.0, 117.0, 256.0, 73.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 484.166656, 359.500031, 92.0, 22.0 ],
					"style" : "",
					"text" : "scale 1. 0. 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 554.0, 132.0, 208.0, 158.0 ],
					"prototypename" : "pixl",
					"varname" : "gametrakr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 586.0, 373.0, 144.0, 111.0 ],
					"prototypename" : "pixl",
					"varname" : "1delayr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 321.0, 192.0, 71.0, 292.0 ],
					"prototypename" : "pixl",
					"varname" : "hemi-m",
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-5::obj-20" : [ "pictctrl[7]", "pictctrl[1]", 0 ],
			"obj-5::obj-48" : [ "pictctrl[6]", "pictctrl[2]", 0 ],
