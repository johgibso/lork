...
maj7 = make_mor([0,2,4,5,7,9,11])
dor7 = make_mor([2,4,5,7,9,11,12])
phr7 = make_mor([4,5,7,9,11,12,14])
lyd7 = make_mor([5,7,9,11,12,14,16])
mix7 = make_mor([7,9,11,12,14,16,17])
aeo7 = make_mor([9,11,12,14,16,17,19])
loc7 = make_mor([11,12,14,16,17,19,21])
...
II_v = make_mor([0,12,18,22])

III_i = make_mor([0,9,15,22])
III_ii = make_mor([0,7,16,24])
III_iii = make_mor([0,8,17,24])
III_iv = make_mor([0,12,15,22])
III_v = make_mor([0,12,17,22])
