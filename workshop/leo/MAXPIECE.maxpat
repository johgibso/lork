...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 92.5, 1194.666626, 72.0, 22.0 ],
					"restore" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 613.333374, 818.666687, 71.0, 22.0 ],
					"restore" : [ 0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 86.666672, 868.0, 100.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 140.5, 1052.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 155.75, 1180.430542, 136.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.5, 1087.194458, 169.0, 62.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 140.5, 1158.430542, 202.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 140.5, 1225.0, 327.0, 160.0 ],
					"prototypename" : "pixl",
					"varname" : "equalizr",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 1211.333374, 1035.333374, 94.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 550.0, 1128.000122, 50.5, 22.0 ],
					"style" : "",
					"text" : "az.drivr",
					"varname" : "az.drivr"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 550.0, 993.333374, 69.0, 22.0 ],
					"style" : "",
					"text" : "az.equalizr",
					"varname" : "az.equalizr"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 280.666687, 146.666702, 50.0, 22.0 ],
									"style" : "",
									"text" : "set 256"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 390.666687, 206.0, 57.0, 22.0 ],
									"style" : "",
									"text" : "r MaxVal"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 280.666687, 204.000015, 79.0, 22.0 ],
									"style" : "",
									"text" : "send MaxVal"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 390.666687, 293.333344, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 405.833252, 256.000031, 75.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 703.0, 97.166649, 169.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 982.583313, 1133.000122, 105.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 628.333374, 102.666649, 74.0, 22.0 ],
					"style" : "",
					"text" : "counter 256"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 664.000061, 156.000015, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 133.0, 83.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 532.0, 895.666687, 124.0, 22.0 ],
					"style" : "",
					"text" : "az.wavr",
					"varname" : "az.wavr"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 864.333374, 857.833364, 583.5, 857.833364 ],
					"order" : 0,
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 673.500061, 521.833344, 992.083313, 521.833344 ],
					"order" : 3,
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 673.500061, 606.166695, 1220.833374, 606.166695 ],
					"order" : 1,
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1333.833496, 1092.166748, 591.0, 1092.166748 ],
					"source" : [ "obj-79", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 4 ],
					"midpoints" : [ 992.083313, 1235.833352, 615.0, 1235.833352 ],
					"source" : [ "obj-9", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1220.833374, 1092.166748, 580.5, 1092.166748 ],
					"source" : [ "obj-96", 0 ]
				}
